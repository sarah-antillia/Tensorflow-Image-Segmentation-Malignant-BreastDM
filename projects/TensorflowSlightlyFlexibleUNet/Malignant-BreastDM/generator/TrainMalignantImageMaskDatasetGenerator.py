...
class ImageMaskDatasetGenerator:
  ...
  def generate(self, subset="SUB*"):
    image_files = glob.glob(self.images_dir + "/BreaDM-Ma-*/" + subset + "/*.jpg")
    mask_files  = glob.glob(self.masks_dir  + "/BreaDM-Ma-*/" + subset + "/*.png")
...
if __name__ == "__main__":
  try:
    output_dir = "./Malignant-BreastDM-master"
    if os.path.exists(output_dir):
      shutil.rmtree(output_dir)
    os.makedirs(output_dir)

    # Training Dataset    
    train_images_dir = "./seg/train/images/"
    train_masks_dir  = "./seg/train/labels/"
